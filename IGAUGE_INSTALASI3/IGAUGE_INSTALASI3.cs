...
String url = "http://mantisid.id/project/osh_2019/api/product/osh_data_c.php";
...
void sendServer() {
  ...
  /*
    Serial.println(F("CEK GPRS SERVICE"));
    at();
    delay(1000);
  ...
  */
  ...
  if (result.toInt() == 1) {
    ...
    //http://mantisid.id/project/osh_2019/api/product/osh_data_c.php?={"Data":"003,20190315213555,2456,02356,02201,01233,05,05"}
